...
export const recipes: Recipe[] = [
  ...
  },
  {
    ...
    ingredients: [
      { quantity: '1 quart', name: 'beef broth', type: 'Misc' },
      { quantity: '1 cup', name: 'dried green lentils', type: 'Misc' },
      { quantity: '1/2 cup', name: 'basmati rice', type: 'Misc' },
      { quantity: '1 tsp', name: 'curry powder', type: 'Condiments' },
      { quantity: '1 tsp', name: 'salt', type: 'Condiments' },
    ],
    steps: [
  ...
  },
  {
    ...
    ingredients: [
      { quantity: '5 teaspoons', name: 'yeast', type: 'Baking' },
      { quantity: '5 cups', name: 'flour', type: 'Baking' },
      { quantity: '4 tablespoons', name: 'vegetable oil', type: 'Baking' },
      { quantity: '2 tablespoons', name: 'sugar', type: 'Baking' },
      { quantity: '2 teaspoons', name: 'salt', type: 'Baking' },
      { quantity: '2 cups', name: 'hot water', type: 'Misc' },
      { quantity: '1/4 cup', name: 'pizza sauce', type: 'Misc' },
      { quantity: '3/4 cup', name: 'mozzarella cheese', type: 'Dairy' },
    ],
    steps: [
  ...
  },
  {
    ...
    ingredients: [
      ...
      { quantity: '1-1/4 cups', name: 'all-purpose flour', type: 'Baking' },
      { quantity: '1 tbsp', name: 'grated orange rind', type: 'Produce' },
      { quantity: '1/4 tsp', name: 'salt', type: 'Baking' },
      { quantity: '1 cup', name: 'cold butter, cubed', type: 'Baking' },
      { quantity: '3/4 cup', name: 'packed brown sugar', type: 'Baking' },
      { quantity: '3 cups', name: 'fresh blueberries', type: 'Produce' },
      { quantity: '1/2 cup', name: 'granulated sugar', type: 'Baking' },
      { quantity: '1/3 cup', name: 'orange juice', type: 'Produce' },
      { quantity: '4 tsp', name: 'cornstarch', type: 'Baking' },
    ],
    steps: [
  ...
  },
  {
    ...
    ingredients: [
      ...
      { quantity: '1/2 cup', name: 'mayonnaise', type: 'Baking' },
      { quantity: '1 tbsp', name: 'lemon zest', type: 'Produce' },
      { quantity: '1 tbsp ', name: 'lemon juice', type: 'Produce' },
      { quantity: '1 1/2 tsp', name: 'curry powder', type: 'Baking' },
      { quantity: '1/4 tsp', name: 'salt', type: 'Baking' },
      { quantity: '2', name: 'ripe mangoes, diced', type: 'Produce' },
      { quantity: '1/4 cup', name: 'dried cranberries', type: 'Produce' },
      { quantity: '2', name: 'green onions, thinly sliced', type: 'Produce' },
      { quantity: '1', name: 'celery stalk, finely chopped', type: 'Produce' },
      { quantity: '6 leaves', name: 'Boston lettuce', type: 'Produce' },
      { quantity: '6', name: 'English muffins, toasted', type: 'Misc' },
    ],
    steps: [
